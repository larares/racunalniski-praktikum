...
ki predstavlja naključno gibanje delcev v mediju.
    ...
    Zdaj lahko zapišemo izrek \label{thm:stopped_brownian}. % Sklic na izrek z oznako thm:stopped_brownian
    
    \begin{izrek}
    \emph{Naj bo $\{B_t\}_{t \geq 0}$ (standardno) Brownovo gibanje, $\tau$ čas ustavljanja glede na 
