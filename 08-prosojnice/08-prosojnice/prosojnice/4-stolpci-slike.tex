	...
	\begin{columns}
		...
		\column{0.45\textwidth}
				...
				\pause	
				 ...
				 % Lok je definiran s točko, v kateri se lok začne (ne središče!), z začetnim in
				 % končnim kotom ter radijem.
				 % Koti so vedno podani enako: kot 0 je v smeri x osi in se veča v nasprotni smeri
				 % urinega kazalca.
				 \coordinate (T') at ({-\td},{\tt});
